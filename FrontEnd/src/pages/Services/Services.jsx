    ...
    <div className=''>
      <div className='mb-16'>
        ...
        <div className='flex flex-col items-center gap-y-14 w-full'>
          ...
          <div className='flex gap-x-16'>
          <ServicesCard name={"Bird Watching"} image={ServiceThumb4} description={description}/>
          <ServicesCard name={"Pet Training"} image={ServiceThumb5} description={description}/>
          <ServicesCard name={"Pet Socialisation"} image={ServiceThumb6} description={description}/>
          </div>
