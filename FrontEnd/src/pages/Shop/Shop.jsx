      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 ">
        ...
        <aside className="hidden sm:block col-span-1 p-3">
          ...
          <div className="filter-by-price mb-16 grid grid-cols-2">
            ...
            <button className="w-3/5 bg-transparent col-span-1 hover:bg-yellow-500 text-black-700 font-semibold hover:text-white border border-yellow-500 hover:border-transparent">
              Filter
            </button>
            <div className="relative mb-3 col-span-1" data-te-input-wrapper-init>
              <input
                type="text"
