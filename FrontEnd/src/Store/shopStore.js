...
const store = (set, get) => ({
    ...
    applyCategory: (category) => {
        ...
        const filteredProducts = get().products.filter((prod) => prod.category == category)
    ...
    sortProducts: (reverse) => {
        ...
        var sortedProducts = []
        if (reverse !== "reverse") sortedProducts = [...prods].sort((a, b) => a.name.localeCompare(b.name))
        else {
    ...
    priceFilter: (reverse) => {
        ...
        if (reverse !== "reverse") filteredProducts = [...prods].sort((a, b) => (a.price - b.price))
