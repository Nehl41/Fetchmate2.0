...
const AcceptedButton=()=>{
  return <button className="border-2 border-black p-2 bg-green-400 text-white text-xl">Accepted </button>
}

const RejectedButton=()=>{
  return <button className="border-2 p-2  bg-red-400 text-white text-xl">Rejected </button>
}
    ...
    <div className="max-w-xs">
      <div className="bg-white shadow-xl rounded-lg py-3">
        ...
        <div class="p-2">
          ...
          {initialStatus=="hanging"?<div className="flex justify-center gap-6">
            <div
          ...
          </div>:(initialStatus=="accepted"?<div className="text-center"><AcceptedButton/></div>:<div className="text-center"><RejectedButton/></div>)}
        </div>
      </div>
    </div>
  );
