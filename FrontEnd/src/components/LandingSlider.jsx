...
const LandingSlider = () => {
  ...
  return (
    <div className="row-span-9 flex items-center justify-around">
    <AiOutlineLeft style={{color:"gray"}} className='text-5xl' onClick={carouselPrev}/>
...
<AiOutlineRight style={{color:"gray"}} className='text-5xl' onClick={carouselNext}/>
    </div>
  )
}
