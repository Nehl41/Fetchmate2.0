...
const NavBar = () => {
  return (
    <nav className="w-screen p-4 px-10 flex items-center">
    ...
    <div className="nav-right w-6/12 flex justify-end">
      ...
      <div className="search-input flex items-center justify-center">
        <AiOutlineSearch className="text-2xl flex content-center"/>
        <input
        class="bg-white h-full px-5 py-4 rounded-lg text-lg"
        type="search"
        name="search"
        placeholder="Search"
      />
      ...
      <button
        type="button"
        class="focus:outline-none bg-yellow-400 hover:bg-yellow-500 font-medium rounded-lg text-xl px-4 py-2 dark:focus:ring-yellow-900"
      >
        Login
      </button>
      <button type="button" class="border-2 text-cyan-400 border-cyan-400 font-medium rounded-lg text-base px-5 py-2.5 text-center border-b-4">Get Started</button>
      </div>
    </div>
  </nav>
  )
